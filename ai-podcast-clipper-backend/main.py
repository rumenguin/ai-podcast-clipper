...
def process_clip(
    ...
    print(
        f"Columbia script processing took {columbia_end_time - columbia_start_time:.2f} seconds"
    )
    ...
    print(
        f"Create vertical video clip {clip_index} took {cvv_end_time - cvv_start_time:.2f} seconds"
    )
    ...
    s3_client.upload_file(
        subtitle_output_path, "ai-podcast-clipper-rumen", output_s3_key
    )
...
class AIPodcastClipper:
    ...
    def process_video(
        ...
        s3_client = boto3.client("s3")
        s3_client.download_file("ai-podcast-clipper-rumen", s3_key, str(video_path))
